/**
 *  ZWave Scene Control to button converter
 *
...
{
    log.debug("Entered buttonEvent() method");
    ...
    if (button > 0)
    {
        ...
        log.debug("Creating button push event for button: ${button}");
        ...
        // Let's ignore the button release for now
        log.debug("Ignoreing button push release event for button: ${button}");
        createEvent([:])

        //result << response(zwave.sceneActuatorConfV1.sceneActuatorConfReport(dimmingDuration: 255, level: 255, sceneId: 0))
    }
    result
    //delayBetween(result, 200)
}

// A zwave command for a button press was received
def zwaveEvent(physicalgraph.zwave.commands.sceneactivationv1.SceneActivationSet cmd)
{
	log.debug("Entered: zwaveEvent(physicalgraph.zwave.commands.sceneactivationv1.SceneActivationSet cmd)");


	// The controller likes to repeat the command... ignore repeats

	if (state.lastScene == cmd.sceneId && (state.repeatCount < 4) && (now() - state.repeatStart < 500))
    {
    ...
    else
    {
        ...
        log.debug("This appears to be a valid press of button: $cmd.sceneId");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.commands.sceneactuatorconfv1.SceneActuatorConfGet() method");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.commands.sceneactuatorconfv1.SceneActuatorConfReport method");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.commands.configurationv1.ConfigurationReport() method");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.commands.hailv1.Hail() method");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.commands.manufacturerspecificv2.ManufacturerSpecificReport() method");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.commands.associationv2.AssociationGroupingsReport() method");
...
{
    log.debug("Entered zwaveEvent(physicalgraph.zwave.Command() method");
...
{
    log.debug("Entered configurationCmds() method");
...
def configure()
{
    log.debug("Entered configure() method");
...
{
/* */
    log.debug("Entered associateLoad() method");
...
def associateHub()
{
    log.debug("Entered associateHub() method");
...
{
    log.debug("Entered updateState() method");
